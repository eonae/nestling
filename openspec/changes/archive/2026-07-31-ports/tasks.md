...
- [x] 9.7 Коммиты осмысленные (4 шт.); **push не выполнен** — в этой
  среде нет доступа к `git@github.com` (Permission denied (publickey)),
  ветка `autorun/v1-all-waves` опережает `origin` на 4 коммита
