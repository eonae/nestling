...
/**
 * Endpoint для импорта пользователей через стриминг.
 *
 * Демонстрирует:
 * - стриминг входных данных: хендлер получает входящий поток;
 * - поэлементную валидацию по схеме-листу, которую делает ядро, а не
 *   хендлер;
