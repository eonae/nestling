 ...
 *
 * Операция заводится **нейтральным**, потому что потребителей у неё
 * несколько и строгость у них разная:
 *
 ...
 *
 * Живёт он здесь, рядом с аннотацией {@link jsonSchemaOf}, которую сам же
 * читает первым источником. Пакет запроса ему не подходит: снимок конфига
 * строится до существования запроса, и обращаться в слой пайплайна конфиг
 * не может.
 */
