...
| 11 | `ports` | `makeContract` (request/command/event), `Port`/`Emitter`, `IMessageBus`, `InProcessBus`, dispatch-policy; local/remote-биндинг на сборке (co-located, L3) | L | **реализован**, ждёт архива — новый пакет [`@nestling/ports`](../../packages/nestling.ports/), [гайд](../guides/ports.md), [ideas.md [2026-07-31]](./ideas.md), [d/05 §3](../history/discussions/05-modular-monolith-features-ports.md) |
