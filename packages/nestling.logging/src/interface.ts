 ...
 * Интерфейс логгера.
 *
 * Ядро, приложение и сателлит пишут через один интерфейс: четыре уровня,
 * три формы вызова у каждого и `child` для привязок. Реализацию выбирает
 * опция `logging` корня; от библиотек логирования интерфейс не зависит.
 */
