...
`guide/`, `recipes/` и `design/`, README каталогов `packages/` и шесть
страниц — `guarantees.md`, `from-nestjs.md`, `glossary.md`,
`conventions.md`, `decisions/roadmap.md` и `decisions/deferred.md`.
Ссылка в файл, который разделом сайта не стал, ведёт на GitHub. Этот
файл, `history/` и `openspec/` на сайте не публикуются.
