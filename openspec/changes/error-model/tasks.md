...
- [ ] 8.7 Коммиты осмысленные, ветка запушена — *коммиты готовы (3 шт.);
      push не прошёл: `git@github.com` отвергает ключ в этом окружении
      (`Permission denied (publickey)`) — требуется push с машины пользователя*
