 ...
 * рождается в WIRE — до него исполнимых ручек не существует **ни у кого**.
 * Значит клиент, инстанцированный на ASSEMBLE, физически не может держать
 * исполнитель, и окно «инстанцирован, но не связан» закрывается внятной
 * ошибкой, а не молчаливым ожиданием.
 */
...
/** Диагностический отчёт вызывателя: то, что не доехало до call-site */
...
/** Исполнители, приезжающие на WIRE */
...
export class PortRuntime {
  ...
  /**
   * Шина для remote-вызова. `undefined` легально: эмиттер события без
  ...
  /** Диагностический канал: отказ, не доехавший до call-site */
