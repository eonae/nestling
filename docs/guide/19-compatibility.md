...
[17](./17-select.md): секреты привязаны источником к ключам секции, потому
...
OpenAPI в главе [12](./12-openapi-and-client.md). Без конвертера лист
...
webhook'а с проверкой подписи: [20. Webhook с проверкой
подписи](./20-webhook.md).
