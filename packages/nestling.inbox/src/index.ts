 ...
 * хендлера не доходит: шаг отметки завершает endpoint досрочным успехом.
 *
 ...
 * шага отметки — его имя стоит в `TNeeds` декларации со слоем.
 */

export { InboxClaimStep } from './claim.js';
