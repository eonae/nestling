...
- [x] 6.1 `yarn verify` и `yarn docs:audit` зелёные
...
- [x] 6.4 Коммиты осмысленные, ветка передана Merger'у сообщением
...
- [x] 7.7 Затронутые `examples/*` мигрированы, гайды пересверены с
