...
| [transports.md](./design/transports.md) | транспорт-центричная HTTP-архитектура | частично реализовано (§1/§3/§5/§7 приведены к актуальным решениям 2026-07; §8–§10 — иллюстративный псевдокод, строчно не сверялся) |
