...
| 61 | `docs-publish` | — | волна 5 уборки: публикация через GitHub Actions и Pages, домен, новые инварианты `docs:audit` | S–M | план — [ideas.md [2026-09-05]](./ideas.md) «Структура документации»; после 60; документация собирается локально и никуда не публикуется |
