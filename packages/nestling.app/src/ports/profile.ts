...
/** Атрибут ключа идемпотентности сообщения */
 ...
 *
 * Значение — всегда строка: у команды ключ кладёт вызыватель (переданный
 * либо чеканенный), а у события и у любого другого транспорта его чеканит
 ...
 * пришедшее вовсе без ключа (событие без ключа издателя или запрос с
