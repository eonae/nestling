# 20. Webhook с проверкой подписи
...
Bearer-токен» из [главы 10](./10-auth.md) к этому endpoint'у не применима.
...
тексте ошибок, как в [главе 7](./07-config.md).
...
10](./10-auth.md): класс-юнит с зависимостью от секции конфига,
...
хендлер. Правило из [главы 10](./10-auth.md) действует и здесь: список
...
Те же декларации и пайплайн работают и в командной строке: [21.
CLI-утилита на тех же примитивах](./21-cli.md).
