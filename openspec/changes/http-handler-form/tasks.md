...
- [ ] 8.1 Глава 4: `Ok` без заголовков, `HttpResponse` для `Location`
- [ ] 8.2 Глава 11: потоковый ответ с заголовками
- [ ] 8.3 Главы 13 и 27: `Ok.created(user, { Location })` переписать
- [ ] 8.4 Глава 15 и глава 24: проверить сниппеты `new Ok(...)`
- [ ] 8.5 Глава 10: HTTP-хендлер с cookie и редиректом, юниты транспорта
- [ ] 8.6 Приложения А и Б: строки про заголовки ответа
- [ ] 8.7 Карта понятий и оглавление, если состав понятий изменился
