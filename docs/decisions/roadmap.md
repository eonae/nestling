...
| 23 | `pipeline-type-dx` | S–M | закрывает окно: снапшоты диагностик и порог tsserver снимаются с уже зафиксированных типов — **done** |
