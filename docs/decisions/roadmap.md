...
| 80 | `readme-positioning` | — | первый абзац README — три гарантии, аудитория названа явно вместе с теми, кому фреймворк не нужен | S | план — [ideas.md [2026-09-12]](./ideas.md) «Разбор обзоров d/10 и d/13»; d/13 §6.2: `docs/guarantees.md` есть, README на него не ведёт |
