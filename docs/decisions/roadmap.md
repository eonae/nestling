...
| 8 + 24 | `endpoint-discovery` + `endpoint-model` | S + M | одним заходом: глобальный реестр умирает вместе с `@Endpoint` — 8 **done**, [архив](../../openspec/changes/archive/2026-07-29-endpoint-discovery/) |
