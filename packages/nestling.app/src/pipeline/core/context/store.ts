 ...
 * фазу. Накопленный `input` — тот же объект, в который pre-шаги
 * дописывают поля, поэтому обновлять ссылку после шага не нужно.
 ...
 * ридер отличает «переменную ещё не положили» от «`.pre`-шаги до неё не
 * дошли».
 */
