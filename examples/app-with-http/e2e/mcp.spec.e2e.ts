 ...
 * протокола обслуживаются рядом с endpoint'ами HTTP и что слой `authed`
 * работает на инструменте так же, как на HTTP-декларации: заголовки
 * запроса агента доходят до пайплайна обычным путём.
 */
...
describe('MCP на сокете приложения', () => {
