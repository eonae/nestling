...
- 📖 [EXAMPLES.md](./EXAMPLES.md) — большая коллекция практических примеров
- 📖 [SCHEMA.md](./SCHEMA.md) — детали работы со схемами в транспортном слое
- 📖 [Документация Zod](https://zod.dev/)
- 📖 [Примеры в репозитории](../../examples/)
