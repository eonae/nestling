...
describe('stub — место в сборке', () => {
  ...
  it('со стабом фича собирается без соседа и без брокера', async () => {
    ...
    // не вызывался ни разу: проверка достижимости стоит в его теле и
    // уронила бы сборку (см. тест выше). Явный провайдер стаба опережает
    // рецепт, поэтому до рецепта дело не доходит
