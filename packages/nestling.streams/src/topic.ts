/**
 * `Topic<T>` — broadcast-примитив источников событий.
 *
 * Ровно примитив: bounded buffer + `AbortSignal`. Ни операторов, ни фабрик
 * «на все случаи», ни наследования — всё это живёт в пользовательском коде
 * поверх обычного `AsyncIterable`.
 */
...
export class Topic<T> {
  ...
  /**
   * Сколько событий не доехало до подписчиков из-за переполнения буфера.
   *
