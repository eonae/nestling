...
- **THEN** сборка падает на фазе BUILD, называя реализацию
...
приложении SHALL быть ошибкой фазы BUILD. Текст SHALL называть операцию и
...
- **THEN** сборка падает на BUILD, называя операцию и оба модуля
