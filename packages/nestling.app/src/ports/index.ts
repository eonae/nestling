/**
 * Слой портов: операции, порты и in-proc шина.
 *
 ...
 * Без них сторонний транспорт (`@nestlingjs/transport.nats` и любой другой)
 ...
 * операции и декоратор роли из `@nestlingjs/container`.
 */
