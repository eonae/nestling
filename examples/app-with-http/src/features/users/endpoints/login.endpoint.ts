 ...
 *
 * Такой класс живёт только в анонимной декларации: адрес объявлен
 * транспортом, поэтому HTTP-специфика здесь допустима. В `implement` и в
 * форму с `operation:` он не проходит по типам, и невозможность
