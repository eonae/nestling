...
Две фичи общаются только операциями:
...
процессах и транспорте. Единственное общее знание — операции в
[`operations.ts`](./src/operations.ts).
...
3. **Долговечность объявлена в операции.** У `orders.placed` стоит
