...
describe('имена правил ESLint', () => {
  it('перечень правил в скилле совпадает с правилами плагина', () => {
    ...
    // Равенство, а не вхождение: новое правило плагина обязано попасть в
    // конфиг `references/setup.md` вместе с абзацем о том, что оно ловит
    expect(named).toEqual(Object.keys(nestlingPlugin.rules).sort());
  });
});
