...
и `@nestlingjs/drizzle.pg` из [главы 27](./27-database-and-transaction.md).
...
[главе 15](./15-live-feed.md): `push` не ждёт наблюдателей, медленный
...
[главы 24](./24-ops.md). Схемы фактов написаны руками в `schema.ts` и
...
[главы 13](./13-features.md): функция принимает решения композиции и
...
Как этим пользуется эксплуатация, показывает [глава 24](./24-ops.md).
