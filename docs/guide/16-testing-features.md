# 16. Тестировать фичу без соседей

> Гайд по текущему API; сверено с кодом `app-with-http`, `split-nats` (2026-09-08).
...
Приложение в проде собирается так же, по частям: [17. Запускать только
часть фич](./17-select.md).
