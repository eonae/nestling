...
import type { DiscoveredEndpoint, SchemaDocConverter } from '@nestlingjs/app';
...
export interface OpenApiOptions {
   ...
   * другого вендора, не теряя умолчания, и **заменяет** его, если несёт
   * конвертер того же вендора.
   *
