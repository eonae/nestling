...
| 82 | `mcp-satellite` | — | сервер MCP из деклараций операций: имя, схемы входа и выхода, отказы и `doc` — готовое определение инструмента | M | план — [ideas.md [2026-09-12]](./ideas.md) «Разбор обзоров d/10 и d/13»; d/13 §6.5: тот же механизм, что OpenAPI и типизированный клиент; преимущество, которого нет у других фреймворков на Node |
