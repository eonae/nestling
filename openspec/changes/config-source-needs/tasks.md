...
- [x] 7.1 Все задачи разделов 1–6 отмечены
- [x] 7.2 `yarn verify:fresh` зелёный — кэш nx реплеит прошлый вывод, и
...
- [x] 7.4 `design/` и `decisions/` синхронизированы по правилам
  `CLAUDE.md`
- [x] 7.5 Запись [ideas.md [2026-09-13]](../../../docs/decisions/ideas.md)
