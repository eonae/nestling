 ...
 *
 * Его берут входы, подлинность которых доказана не токеном: сообщение
 * шины пришло от relay, webhook подписан секретом. Наблюдаемость
 * остаётся — оба пишут ту же строку аудита, что и HTTP-endpoint.
 */
