 ...
 * (провенанс композиции). Прогоняет политики `@nestlingjs/app`: он собирает
...
export interface EndpointFilter {
  /**
   * DI-токен транспорта (`HttpTransport$`), сравнение — по ссылке.
   *
 ...
 *
 * @param filter - Сужение множества: DI-токен транспорта и/или RegExp по
 *   паттерну
