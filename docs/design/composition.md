...
`--help` печатает схему и завершает процесс. Разбор строгий: неизвестный
флаг, неизвестная фича или чужое значение переключателя — отказ до фазы 0.
Ядро `process.argv` само не читает.
