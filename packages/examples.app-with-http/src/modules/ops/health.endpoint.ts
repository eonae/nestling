...
export const Health = httpEndpoint({
  ...
  // Второй opt-out, той же формы и по той же причине: ручка есть, но
  // внешнему потребителю API она не адресована. `hidden` — единственный
  // способ не документировать HTTP-ручку, и он требует причину, чтобы
  // список скрытого можно было прочитать на ревью
