...
|---|---|---|---|
| 19 | `standard-schema` | S–M | самый нижний слой (валидация): чем раньше, тем меньше кода написано против `z.ZodType` |
| 17 | `pipeline-drop-after` | S | чистое удаление фазы; после появления новых слоёв дорожает |
