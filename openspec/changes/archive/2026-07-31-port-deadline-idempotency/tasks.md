...
- [ ] 8.7 Коммиты осмысленные, ветка запушена — коммиты сделаны, **пуш
  остался за пользователем**: SSH-ключ зашифрован, passphrase в keychain
  нет, агент пуст, а сессия архивации неинтерактивная
