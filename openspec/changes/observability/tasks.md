...
- [ ] 6.1 Добавить в `@nestlingjs/client` заголовок `traceparent` из
  текущей переменной `Trace`; заголовок конфигурации сильнее
- [ ] 6.2 Рантайм-тесты клиента: трасса продолжается, явный заголовок
