 ...
 * умеет требовать токен семейства, но не умеет его запрещать.
 *
 ...
 *
 * `Family.auto` заменяется на токена семейства здесь, при декорировании: класс
 * потребителя уже известен, поэтому в метаданные попадает обычный DI-токен
 * токена семейства, и дальше заместителя никто не видит.
 */
