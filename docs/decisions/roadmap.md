...
| 21 | `input-bind` | M | поверх новых деклараций; несущий уровень для 20 и 22 — **done** (apply 2026-07-30) |
