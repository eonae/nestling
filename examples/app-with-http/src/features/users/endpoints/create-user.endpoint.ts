...
class CreateUserHandler {
  ...
  async handle(
    ...
    // Статус 201 задаётся на успешном ответе. Заголовок ответа задала бы
    // HTTP-форма хендлера, но реализация операции её не принимает: класс
    // должен оставаться переносимым на шину
