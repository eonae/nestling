 ...
 * Недостающий ключ вызыватель событию не чеканит: ключ команды —
 * идентичность намерения, и вызывающий может её выдумать, а у факта такой
 * идентичности нет. Сгенерированный ключ выглядел бы основанием для
