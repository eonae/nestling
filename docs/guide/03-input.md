...
> `input`: обязанность рантайма, точка после `.pre`-шагов».
...
не хендлера или шага пайплайна: отключить её нельзя, а принять любое
...
[14. Выделить вторую область](./14-features.md).
