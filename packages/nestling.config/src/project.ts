 ...
 * остальных, и все отказы уезжают в одну ошибку. Отсутствие значения не
...
/**
 * Материализует секцию: обычная — замороженный снимок, reloadable — живой
 * хэндл, поставленный читалке на перепроекцию.
 */
