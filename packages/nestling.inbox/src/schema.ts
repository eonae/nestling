 ...
 * четырёх полей, пакету не нужен ни zod, ни valibot — и приложение не
 * обязано выбирать того же вендора, что автор пакета. Тот же приём, что у
 * kernel-секции портов.
 *
 * Здесь ровно столько, сколько нужно секции пакета: целые числа с
 * умолчанием и флаг. За объединениями и вложенностью идут к настоящему
 * вендору.
 */
