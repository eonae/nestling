> **СУПЕРСИД (2026-07-13).** Содержимое распределено по докам целевого состояния V1:
> design/composition.md + design/container.md + design/config.md + design/endpoints.md. Здесь — замороженная версия на момент реструктуризации.
